...
from .api_client import RapidAPISkyscannerClient
from .response_mapper import RapidAPIResponseMapper
...
class RapidAPISkyscannerProvider(BaseFlightProvider):
    def __init__(
        self,
        api_key: str,
        ...
        self._api_client = RapidAPISkyscannerClient(api_key, http_client)
        self._mapper = RapidAPIResponseMapper()

    @property
    def provider_name(self) -> str:
        return "rapidapi_skyscanner"
